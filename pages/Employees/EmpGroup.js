...
const EmpGroup = () => {
  ...
  const dataHandle = async () => {
    ...
    // const docRef = doc(firestore, 'UserDetails', auth.currentUser.email)
  ...
  const sentMsg = async () => {
    try {
     // console.log(uData.data().userName);
      console.log('senting...')
      setMsg('')
  ...
  useEffect(() => {
    dataHandle();
    console.log("helloo",uData.userName)
  ...
  const renderItem = ({ item }) => (
    <View
      style={[
        styles.messages,
        item.name == userName ? { alignItems: 'flex-end' } : {},
      ]}
    >
